...
const diabetesTypes = ['type1', 'type2', 'gestational', 'prediabetes', 'none'] as const;
const activityLevels = ['sedentary', 'lightly_active', 'moderately_active', 'very_active', 'extra_active'] as const;
